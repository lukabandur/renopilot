...
// ─── IDEEN TAB ────────────────────────────────────────────────────────────────
const TRENDS = [
  { cat:"Bad", title:"Wellness Walk-In Dusche", desc:"Bodengleiche Dusche mit Regendusche und 8mm ESG-Glasabtrennung. Gefälleestrich, Dichtschlämme 2-lagig. Kein Stemmen wenn Gefälleestrich neu aufgebaut wird.", how:"Installateur + DIY-Anteil", budget:"1.500–5.000€", emoji:"🚿", img:"https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=600&h=220&fit=crop&q=80", amazon:"walk-in dusche komplett set glaswand" },
  { cat:"Bad", title:"Freistehende Badewanne", desc:"Ein Statement-Stück das jeden Raum verwandelt. Acryl oder Gusseisen, Boden-Armatur separat daneben. Wirkt wie ein 5-Sterne-Hotel.", how:"Installateur für Anschluss", budget:"800–3.000€", emoji:"🛁", img:"https://images.unsplash.com/photo-1507652313519-d4e9174996dd?w=600&h=220&fit=crop&q=80", amazon:"freistehende badewanne acryl oval weiß" },
  { cat:"Bad", title:"Mikrozement fugenlos", desc:"Beton-Look ohne eine einzige Fuge – direkt über alte Fliesen möglich. 3 Lagen auftragen, jede schleifen, dann 2× PU-Versiegelung. Antibakteriell, pflegeleicht, zeitlos.", how:"DIY mit Vorbereitung", budget:"60–120€/m²", emoji:"🏛️", img:"https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=600&h=220&fit=crop&q=80", amazon:"mikrozement set komplett wand boden" },
  { cat:"Bad", title:"Mattschwarz Armaturen", desc:"Kompletter Stil-Wandel für unter 500€. Armatur tauschen = DIY in 2h. Dazu LED-Spiegel IP44 und Mattschwarz-Accessoires.", how:"DIY – 2–4 Stunden", budget:"200–600€", emoji:"🖤", img:"https://images.unsplash.com/photo-1580480055273-228ff5388ef8?w=600&h=220&fit=crop&q=80", amazon:"grohe armatur mattschwarz bad" },
  { cat:"Bad", title:"Zellige Wandfliesen", desc:"Handgemachte marokkanische Fliesen 10×10cm – jede einzigartig. Direkt über alte Fliesen mit Spezialkleber möglich.", how:"DIY – Wochenende", budget:"40–120€/m²", emoji:"🟤", img:"https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=600&h=220&fit=crop&q=80", amazon:"zellige fliesen handgemacht marokkanisch" },
  { cat:"Bad", title:"Großformat-Fliesen 120×60cm", desc:"Weniger Fugen = mehr Luxus. 120×60cm Feinsteinzeug lässt Räume größer wirken. Doppelklebung Pflicht! Nivelliersystem verwenden.", how:"Fliesenleger empfohlen", budget:"35–70€/m²", emoji:"⬛", img:"https://images.unsplash.com/photo-1599619351208-3e6c839d6828?w=600&h=220&fit=crop&q=80", amazon:"feinsteinzeug fliesen 120x60 anthrazit" },
  { cat:"Bad", title:"Schwimmender Waschtisch", desc:"Wandhängender Waschtisch aus Massivholz schafft Spa-Atmosphäre und macht den Boden optisch größer. Vorwand aus Rigips nötig.", how:"Installateur + DIY", budget:"400–1.200€", emoji:"🪵", img:"https://images.unsplash.com/photo-1564540574859-0dfb63985953?w=600&h=220&fit=crop&q=80", amazon:"waschtisch holz wandmontage schwebend" },
  { cat:"Bad", title:"LED-Spiegel Hinterleuchtet", desc:"Schimmerndes Licht hinter dem Spiegel = Luxus-Look. IP44, dimmbar, oft mit Beschlagschutz. Einfachste Installation per Stecker.", how:"DIY – 30 Minuten", budget:"80–400€", emoji:"💡", img:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=220&fit=crop&q=80", amazon:"led spiegel bad hinterbeleuchtet ip44 dimmbar" },
  { cat:"Küche", title:"Dunkle Fronten Navy & Grün", desc:"Navy-Blau, Flaschengrün, Anthrazit – weg von ewig Weiß. Fronten lackieren: P120 schleifen → Haftgrund → 3× Seidenmatt-Lack.", how:"DIY – 2–3 Tage", budget:"100–400€", emoji:"🍳", img:"https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=220&fit=crop&q=80", amazon:"küchen fronten lackieren seidenmatt set" },
  { cat:"Küche", title:"Offene Holzregale", desc:"Hängeschränke raus, schwebende Massivholzbretter rein. Eiche oder Nussbaum, 4cm stark, geölt. Raum wirkt sofort größer.", how:"DIY – halber Tag", budget:"100–300€", emoji:"📚", img:"https://images.unsplash.com/photo-1556909211-36987e6e9a65?w=600&h=220&fit=crop&q=80", amazon:"eiche massivholz regalbrett küche geölt" },
  { cat:"Küche", title:"Kücheninsel aus IKEA", desc:"IKEA KALLAX als Basis, dazu eine Massivholzplatte – fertig ist die Insel. Barhocker dazu = Familientreffpunkt.", how:"DIY – Wochenende", budget:"300–700€", emoji:"🏝️", img:"https://images.unsplash.com/photo-1565538810643-b5bdb714032a?w=600&h=220&fit=crop&q=80", amazon:"kücheninsel massivholzplatte eiche" },
  { cat:"Küche", title:"Zellige Küchenrückwand", desc:"Handgemachte Fliesen als Rückwand – 7,5×15cm Metro in Weiß, Cremé oder Salbeigrün. Direkt über alte Fliesen möglich.", how:"DIY – 1 Tag", budget:"50–150€", emoji:"⬜", img:"https://images.unsplash.com/photo-1556909048-f0a46d7c3c0a?w=600&h=220&fit=crop&q=80", amazon:"metro fliesen küche zellige handgemacht" },
  { cat:"Küche", title:"Messing & Gold Akzente", desc:"Griffe, Armaturen, Lampen in gebürstetem Messing verwandeln jede Küche. Einfachster Upgrade: 20er-Pack Bügel-Griffe 128mm tauschen.", how:"DIY – 30 Minuten", budget:"40–150€", emoji:"✨", img:"https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=600&h=220&fit=crop&q=80", amazon:"küchen griffe messing gebürstet 128mm set" },
  { cat:"Küche", title:"Butcher Block Arbeitsplatte", desc:"Massivholz-Arbeitsplatte als Kontrastpunkt zu dunklen Fronten. Jährlich ölen mit Osmo Hartwachsöl. Schnittkanten sofort abdichten!", how:"DIY bei Tausch", budget:"80–300€", emoji:"🪵", img:"https://images.unsplash.com/photo-1556910638-6cdac31d8c23?w=600&h=220&fit=crop&q=80", amazon:"holzarbeitsplatte küche massiv buche eiche" },
  { cat:"Wohnzimmer", title:"Akzentwand Dunkelgrün", desc:"Eine Wand in Flaschengrün (RAL 6009). Lammfellrolle, 2 Schichten, Tesa Precision. Größte Wirkung für 30–60€.", how:"DIY – 1 Tag", budget:"30–80€", emoji:"🌿", img:"https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&h=220&fit=crop&q=80", amazon:"wandfarbe dunkelgrün matt wohnzimmer" },
  { cat:"Wohnzimmer", title:"TV-Wand Fluted Panel", desc:"Gerillte MDF-Latten hinter dem TV – Statement-Wand für unter 200€. LED-Strip 2700K dahinter = Magazin-Look sofort.", how:"DIY – halber Tag", budget:"80–250€", emoji:"📺", img:"https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=220&fit=crop&q=80", amazon:"wandpaneele mdf fluted panel holz wohnzimmer" },
  { cat:"Wohnzimmer", title:"Cove-Licht Deckenrand", desc:"Holzkastenrahmen 15cm am Deckenrand, LED-Strip 2700K dahinter. Licht strahlt zur Decke = warmes indirektes Licht wie im Hotel.", how:"DIY – Wochenende", budget:"150–350€", emoji:"✨", img:"https://images.unsplash.com/photo-1600210492493-0946911123ea?w=600&h=220&fit=crop&q=80", amazon:"led strip 2700k cove licht warmweiß" },
  { cat:"Wohnzimmer", title:"Erdetöne & Rattan 2026", desc:"Terrakotta, Ocker, Sandstein dominieren 2026. Rattan-Sessel, Jute-Teppich, handgemachte Keramik. Sofort umsetzbar ohne Handwerker.", how:"Sofort umsetzbar", budget:"200–600€", emoji:"🍂", img:"https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&h=220&fit=crop&q=80", amazon:"rattan sessel jute teppich terrakotta deko" },
  { cat:"Wohnzimmer", title:"Limewash Wand", desc:"Kalkputz-Optik mit lebendiger Textur, jede Wand einzigartig. Trendfarben: Warm Greige, Staubiges Rosa, Tiefes Blaugrau.", how:"DIY – 1 Tag", budget:"40–100€", emoji:"🏺", img:"https://images.unsplash.com/photo-1558882224-dda166733046?w=600&h=220&fit=crop&q=80", amazon:"limewash farbe kalkputz optik wand" },
  { cat:"Wohnzimmer", title:"Einbauregal Statement", desc:"Regal von Wand zu Wand, Boden bis Decke, mit LED-Cove dahinter. MDF-Aufbau, weiß lackiert oder Eiche. Enormer Mehrwert.", how:"Mittel – 2 Wochenenden", budget:"300–1.500€", emoji:"📖", img:"https://images.unsplash.com/photo-1565183928294-7063f23ce0f8?w=600&h=220&fit=crop&q=80", amazon:"einbauregal wohnzimmer mdf wand zu wand" },
  { cat:"Schlafzimmer", title:"Bouclé Kopfteil DIY", desc:"MDF-Platte + 5cm Schaumstoff RG35 + Bouclé-Stoff tackern. Ergebnis = 5-Sterne-Hotel-Feeling. Wand dahinter in Terrakotta.", how:"DIY – 4 Stunden", budget:"80–200€", emoji:"🛏️", img:"https://images.unsplash.com/photo-1617325247661-675ab4b64ae2?w=600&h=220&fit=crop&q=80", amazon:"bouclé stoff creme polsterstoff meterware" },
  { cat:"Schlafzimmer", title:"Dunkle Decke Nachtblau", desc:"Nur die Decke in Nachtblau (Farrow & Ball Hague Blue). Wände weiß lassen. Erzeugt Geborgenheitsgefühl. 2200K Wandleuchten dazu.", how:"DIY – 3 Stunden", budget:"25–60€", emoji:"🌙", img:"https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&h=220&fit=crop&q=80", amazon:"wandfarbe nachtblau dunkelblau matt schlafzimmer" },
  { cat:"Schlafzimmer", title:"Wandleuchten Gelenkarm", desc:"Wandleuchten beidseitig neben dem Bett ersetzen Nachttischlampen. Schlanker Look, mehr Platz. Stecker-Variante = kein Elektriker!", how:"DIY – 1 Stunde", budget:"60–200€", emoji:"💡", img:"https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=600&h=220&fit=crop&q=80", amazon:"wandleuchte gelenkarm schlafzimmer messing" },
  { cat:"Schlafzimmer", title:"Japandi Akzentwand", desc:"Helles Greige mit Holzlatten als vertikale Struktur. Minimalistisch, ruhig, zeitlos. Kombination aus japanisch und skandinavisch.", how:"DIY – 1 Tag", budget:"50–150€", emoji:"🎋", img:"https://images.unsplash.com/photo-1540518614846-7eded433c457?w=600&h=220&fit=crop&q=80", amazon:"wandleisten holz vertikal schlafzimmer japandi" },
  { cat:"Boden", title:"SPC-Vinyl über Fliesen", desc:"100% wasserfest, Klicksystem direkt über alte Fliesen. Kein Stemmen, kein Kleber. Eiche-Optik oder Betongrau. Fertig in einem Tag.", how:"DIY – 1 Tag", budget:"15–35€/m²", emoji:"🪵", img:"https://images.unsplash.com/photo-1574739782594-db4ead022697?w=600&h=220&fit=crop&q=80", amazon:"spc vinyl klick wasserfest über fliesen" },
  { cat:"Boden", title:"Fischgrät-Parkett", desc:"Dielen in Fischgrät-Muster = eleganteste Verlegeart. Eiche geölt oder gebürstet, schwimmend verlegt. Wertsteigernd, zeitlos.", how:"Mittel – Wochenende", budget:"40–80€/m²", emoji:"⬛", img:"https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=600&h=220&fit=crop&q=80", amazon:"fertigparkett eiche fischgrät geölt" },
  { cat:"Boden", title:"Betonoptik Epoxidharz", desc:"Fugenloser, glänzender Betonboden direkt über altem Boden. Sehr strapazierfähig, ideal für Küche und Flur.", how:"Fortgeschritten – Wochenende", budget:"20–50€/m²", emoji:"🔘", img:"https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=220&fit=crop&q=80", amazon:"epoxidharz boden betonoptik set" },
  { cat:"Terrasse", title:"WPC-Terrasse selbst bauen", desc:"WPC-Dielen auf Stelzlagern – wartungsfrei, splitterfrei. Unsichtbare Clip-Befestigung. Über Beton direkt möglich.", how:"Mittel – Wochenende", budget:"35–65€/m²", emoji:"🌴", img:"https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=600&h=220&fit=crop&q=80", amazon:"wpc dielen terrasse stelzlager clip" },
  { cat:"Terrasse", title:"Outdoor-Lounge Design", desc:"Modulare Lounge-Gruppe, Sunbrella-Kissen, Solar-Lichterketten 2200K. Outdoor-Teppich als Basis. Fertig in 2 Stunden.", how:"Sofort umsetzbar", budget:"300–1.200€", emoji:"☀️", img:"https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=220&fit=crop&q=80", amazon:"outdoor lounge set polyrattan sunbrella kissen" },
  { cat:"Terrasse", title:"Pergola Douglasie", desc:"Freistehende Pergola aus Douglasie – wetterfest ohne Imprägnierung. Mit Rankpflanzen oder Segel-Sonnenschutz kombinieren.", how:"Mittel – Wochenende", budget:"400–1.500€", emoji:"🌿", img:"https://images.unsplash.com/photo-1416879595882-b3d065a0e45d?w=600&h=220&fit=crop&q=80", amazon:"pergola bausatz douglasie holz garten" },
  { cat:"Terrasse", title:"Außenküche mit Grill", desc:"Modulare Außenküche mit eingebautem Gasgrill, Arbeitsfläche aus Feinsteinzeug. Das Upgrade für gesellige Abende.", how:"Fortgeschritten", budget:"800–4.000€", emoji:"🔥", img:"https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=600&h=220&fit=crop&q=80", amazon:"aussenküche grill eingebaut outdoor set" },
  { cat:"Terrasse", title:"Mediterrane Oase", desc:"Olivenbäume in Terrakotta-Töpfen, Lavendel, Sandstein-Fliesen, Rankrosen an der Wand. Ohne Handwerker umsetzbar.", how:"Sofort umsetzbar", budget:"200–600€", emoji:"🫒", img:"https://images.unsplash.com/photo-1558882224-dda166733046?w=600&h=220&fit=crop&q=80", amazon:"olivenbaum terrasse terrakotta topf groß" },
];
